...
OS="linux-gnu"
CC="clang"
CFLAGS="-I/opt/mlibc/include -isystem /opt/mlibc/include -ffreestanding -nostdlib -nostartfiles -fno-pic -fno-stack-protector -mcmodel=large -g -DHANDLE_MULTIBYTE -DHAVE_STRERROR -std=gnu89"
RELEASE="5.2"
